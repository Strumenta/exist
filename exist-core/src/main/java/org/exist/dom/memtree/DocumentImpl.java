...
public class DocumentImpl extends NodeImpl<DocumentImpl> implements Document {
    ...
    // TODO(AR) doesn't this need to be thread-safe? -- as this is access by many brokers in parallel potentially? -- why do we even need a docId here (see above)?
    private static long nextDocId = 0;

    // TODO(AR) can we remove the explicitlyCreated parameter?
    ...
    public NodeImpl getLastAttr() {
        ...
        return new AttrImpl(this, attrNum);
    }
